...
<div className="flex flex-col lg:flex-row mx-10 gap-6 mt-8">
  ...
  <option value="North Central">North Central</option>
            ...
            {/* <div>
                ...
                <input type="text" id="province" className="w-full h-[60px] sm:w-[390px] border-gray-500 rounded-lg border p-3" />
            </div> */}
        </div>
    ...
    {/* <div className="w-full lg:w-1/2 md:mx-20 mt-4 lg:mt-12">
        <div className="mt-4">
            <table className="w-full table-auto">
                ...
                <tbody>
                    <tr>
                        <td className="py-2 text-gray-500">Asgaard Sofa</td>
                        <td className="py-2 text-gray-500">X</td>
  ...
  <span className="ml-2">Direct Bank Transfer</span>
        ...
        {/* <div className="flex items-center mt-4">
            <input type="radio" id="bankTransfer" name="payment" className="mr-2 peer hidden" />
            <label
    htmlFor="bankTransfer"
    className="w-4 h-4 border-2 border-black rounded-full flex items-center justify-center cursor-pointer peer-checked:bg-black"
  ></label>
  ...
  <button className="mt-6 border border-black py-3 px-14 rounded-xl text-cente hover:bg-gray-700 hover:text-white transition-colors duration-300">
    Place Order
        ...
        {/* <button className="mt-6 border border-black py-3 px-14 rounded-xl text-center flex justify-center">Place Order</button> */}
    </div>
</div>
 </div>
