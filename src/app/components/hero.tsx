export default function Hero() {
  return (
    <section className="bg-[#FBEBB5] w-full md:h-[700px] flex items-center justify-center pt-14">
      <div className="container mx-auto max-w-[1440px] flex flex-col lg:flex-row items-center">
        ...
        <div className="flex-1 px-4 sm:px-8 md:px-12 lg:pl-[150px] text-center lg:text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black mb-4 lg:mb-6 md:mt-0 mt-12">
            Rocket single
          </h1>
